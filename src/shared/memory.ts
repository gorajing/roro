...
// (The legacy MemoryModule shapes — MemoryKind/MemoryRow/RememberInput/ReplaceFactInput and the flat
// MemoryMatch — were deleted with adapter.ts in the W5 unification. Everything speaks Entry now.)
